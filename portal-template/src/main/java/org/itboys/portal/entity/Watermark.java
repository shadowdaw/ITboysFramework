 ...
 *
 */
@Entity(value = "Watermark", noClassnameStored = true)
public class Watermark extends BaseLongIdEntity {

	private static final long serialVersionUID = -6331700054797039198L;

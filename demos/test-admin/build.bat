...
:mvn_build3
	...
	java -Dserver.port=1984 -Xms256m -Xmx256m -XX:PermSize=64m -Xss256k -XX:+DisableExplicitGC -XX:+UseParNewGC -XX:+UseCMSCompactAtFullCollection -XX:-CMSParallelRemarkEnabled -XX:+PrintGCTimeStamps -XX:+PrintGCDetails -Xloggc:d:/logs/gc.log  -jar test-admin-2.0.jar
	goto mvn_end

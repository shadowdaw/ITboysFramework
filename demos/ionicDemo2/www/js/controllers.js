...
.controller('ShopdetailCtrl', function($scope,$ionicPopover,Shopdetail) {
...
$scope.productId=$stateParams.productId;
  $scope.closeProductDetail=function(){
   window.location.href="#/shopdetail/"+$scope.productId;
  };
 $scope.topaypage=function(){
   window.location.href="#/topay/"+$scope.productId;
  };

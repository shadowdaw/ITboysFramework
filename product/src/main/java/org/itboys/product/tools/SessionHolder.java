...
public class SessionHolder {
	 ...
	 * @return
	 */
	public static <T extends BaseEntity> void prepareAdminLoginData(T t) {
	 ...
	 * @return
	 */
	public static <T extends BaseEntity> void prepareMemberLoginData(T t) {
	 ...
	 * @return
	 */
	public static <T extends BaseEntity> void prepareProjectLoginData(T t) {
	 ...
	 * @param t
	 */
	public static <T extends BaseEntity> void prepareAdminAndProjectLoginData(T t) {
